...
# ==========================================
with tab_analisis:
    st.markdown("<h1>Mengenal Sumber Data</h1>")
    ...
    with f_c1:
        ...
        with f_c1: st.markdown('<div class="feature-card"><b>🧊 Frozen</b><br>Makanan beku seperti nugget dan sosis.</div>', unsafe_allow_html=True)
    with f_c2:
